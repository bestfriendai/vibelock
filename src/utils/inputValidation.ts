 ...
 */
export function validateReviewText(text: string, maxLength: number = 1000): { isValid: boolean; sanitized: string; error?: string } {
 ...
 */
export function validateLocation(city: string, state: string): { isValid: boolean; sanitizedCity: string; sanitizedState: string; error?: string } {
 ...
 */
export function validateSocialHandle(handle: string, platform: string): { isValid: boolean; sanitized: string; error?: string } {
...
export function validateSearchQuery(query: string): { isValid: boolean; sanitized: string; error?: string } {
  ...
  const sanitized = sanitizeText(query, 100);
