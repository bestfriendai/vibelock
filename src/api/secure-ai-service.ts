...
export const generateOpenAIResponse = (prompt: string, model?: string, options?: { maxTokens?: number; temperature?: number }) =>
  secureAIService.generateOpenAIResponse(prompt, model, options);

export const generateAnthropicResponse = (prompt: string, model?: string, options?: { maxTokens?: number; temperature?: number }) =>
  secureAIService.generateAnthropicResponse(prompt, model, options);

export const generateGrokResponse = (prompt: string, model?: string, options?: { maxTokens?: number; temperature?: number }) =>
  secureAIService.generateGrokResponse(prompt, model, options);

export const generateAIResponse = (prompt: string, preferredProvider?: 'openai' | 'anthropic' | 'grok', options?: { maxTokens?: number; temperature?: number }) =>
