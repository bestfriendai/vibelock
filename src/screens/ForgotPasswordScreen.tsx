            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
              <View style={{ flex: 1, paddingHorizontal: 24, justifyContent: "center" }}>
                ...
                <Animated.View style={[footerAnimatedStyle, { gap: 16 }]}>
                  <AnimatedButton title="Back to Sign In" variant="primary" onPress={handleBackToSignIn} />
          ...
          <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
            <View style={{ flex: 1, paddingHorizontal: 24, justifyContent: "center" }}>
              ...
              <Animated.View style={[footerAnimatedStyle, { alignItems: "center" }]}>
                ...
                <AnimatedButton title="Back to Sign In" variant="ghost" size="small" onPress={handleBackToSignIn} />
              </Animated.View>
            </View>
          </ScrollView>
        </TouchableWithoutFeedback>
