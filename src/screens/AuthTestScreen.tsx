...
export default function AuthTestScreen() {
  ...
  const handleRunTests = async () => {
    ...
    try {
      ...
      Alert.alert("Tests Complete", "Authentication tests have finished. Check the console for detailed results.", [
        { text: "OK" },
      ]);
    } catch (error: any) {
  ...
  const handleTestConnection = async () => {
    ...
    Alert.alert("Connection Test", isConnected ? "Supabase connection successful!" : "Supabase connection failed!", [
      { text: "OK" },
    ]);
  };
      ...
      <SafeAreaView style={{ flex: 1 }}>
        <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 20 }}>
          ...
          <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 30 }}>
            ...
            <Text style={{ color: "white", fontSize: 24, fontWeight: "bold" }}>Auth Tests</Text>
          </View>
          ...
          >
            ...
            <Text style={{ color: "#D1D5DB", fontSize: 14, lineHeight: 20 }}>
              This screen allows you to test all Supabase authentication functions including signup, signin, password
              reset, and session management. Results will be logged to the console.
            </Text>
          </View>
          ...
          <View style={{ gap: 16 }}>
            ...
            >
              <Text style={{ color: "#60A5FA", fontSize: 16, fontWeight: "600" }}>Test Connection</Text>
              <Text style={{ color: "#9CA3AF", fontSize: 12, marginTop: 4 }}>Quick connection test to Supabase</Text>
            </Pressable>
          ...
          >
            <Text style={{ color: "white", fontSize: 16, fontWeight: "600", marginBottom: 12 }}>Tests Include:</Text>
            <View style={{ gap: 8 }}>
              {[
                "Connection Test",
                "User Sign Up",
          ...
          >
            <Text style={{ color: "#F59E0B", fontSize: 14, fontWeight: "600", marginBottom: 4 }}>⚠️ Note</Text>
            <Text style={{ color: "#D1D5DB", fontSize: 12, lineHeight: 18 }}>
              Tests will create temporary user accounts and may send emails. Check the console for detailed results and
              any error messages.
            </Text>
          </View>
        </ScrollView>
