...
class LocationService {
  ...
  private getFallbackLocation(): LocationDetectionResult {
    const fallbackCities = [
      { city: 'New York', state: 'NY', coords: { latitude: 40.7128, longitude: -74.0060 } },
      ...
      { city: 'Phoenix', state: 'AZ', coords: { latitude: 33.4484, longitude: -112.0740 } },
      ...
      { city: 'Dallas', state: 'TX', coords: { latitude: 32.7767, longitude: -96.7970 } },
