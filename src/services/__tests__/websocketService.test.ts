...
describe("SupabaseRealtimeService - Expo SDK 54 Compatibility", () => {
  ...
  describe("Room Management", () => {
    ...
    it("should join room successfully", async () => {
      ...
      expect(mockCallbacks.onUserJoin).toHaveBeenCalledWith("test-user-id", "Test User", "test-room-id");
    });
    ...
    it("should leave room successfully", async () => {
      ...
      expect(mockCallbacks.onUserLeave).toHaveBeenCalledWith("test-user-id", "test-room-id");
    });
