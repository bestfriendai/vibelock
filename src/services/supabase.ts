...
export const supabaseComments = {
  createComment: async () => { throw new Error('Please use modular services'); },
  getComments: async () => { throw new Error('Please use modular services'); },
  updateComment: async () => { throw new Error('Please use modular services'); },
  deleteComment: async () => { throw new Error('Please use modular services'); },
  onCommentsSnapshot: () => { throw new Error('Please use modular services'); },
};