...
export const ChatroomTestButton: React.FC<ChatroomTestButtonProps> = ({ onTestComplete }) => {
  ...
  return (
    <>
      ...
      >
        <Ionicons name={isRunning ? "hourglass" : "flask"} size={16} color="white" style={{ marginRight: 8 }} />
        <Text className="text-white font-medium">{isRunning ? "Running Tests..." : "Test Chatroom"}</Text>
      </TouchableOpacity>
        ...
        <View className="flex-1 bg-black/50 justify-center items-center p-4">
          ...
          >
            ...
            <View className="mb-4">
              ...
              <View className="h-2 bg-gray-200 rounded-full mt-2" style={{ backgroundColor: colors.background }}>
                <View
            ...
            <TouchableOpacity onPress={() => setShowResults(false)} className="mt-4 bg-blue-600 py-3 rounded-lg">
