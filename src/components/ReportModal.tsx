...
const REPORT_REASONS = [
  { key: "inappropriate_content", label: "Inappropriate Content", description: "Contains offensive or inappropriate material" },
          ...
          <View className="p-4">
            ...
            <View className="bg-gray-50 rounded-lg p-4 mb-6">
              ...
              <Text className="text-gray-900 font-medium">
                {itemName || `${itemType} #${itemId.slice(-6)}`}
              </Text>
            </View>
              ...
              <View className="flex-row items-start">
                ...
                <View className="ml-3 flex-1">
                  ...
                  <Text className="text-blue-800 text-sm">
                    We take reports seriously and review them promptly. False reports may result in account restrictions. Thank you for helping keep our community safe.
                  </Text>
                </View>
              </View>
            </View>
