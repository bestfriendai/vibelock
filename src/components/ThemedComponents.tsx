...
export const ThemedCard: React.FC<ThemedCardProps> = ({
  ...
  return <View className={`${themeClasses} ${className}`} style={[cardStyles, style]} {...props} />;
};
...
export const useThemedStyles = () => {
  ...
  return {
    colors,
    isDarkMode,
    getThemeClass: (lightClass: string, darkClass: string) => (isDarkMode ? darkClass : lightClass),
    getThemeStyle: (lightStyle: object, darkStyle: object) => (isDarkMode ? darkStyle : lightStyle),
  };
};
