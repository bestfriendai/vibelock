    ...
    <SafeAreaView className="flex-1 bg-surface-900">
      <View className="p-6">
        ...
        <Text className="text-text-secondary text-sm mb-6">
          Test specific error dialogs for authentication failures. Each test should show a specific error dialog instead of generic error messages.
        </Text>
        ...
        <View className="bg-surface-800 rounded-lg p-4 mb-6">
          ...
          <View className="space-y-2">
            <Text className="text-text-secondary text-sm">• Invalid email: "Email not valid, try a different email"</Text>
            <Text className="text-text-secondary text-sm">• Wrong credentials: "Email/Password is incorrect"</Text>
            <Text className="text-text-secondary text-sm">• Short password: "Password must be at least 6 characters long"</Text>
            <Text className="text-text-secondary text-sm">• Empty fields: "Email is required" / "Password is required"</Text>
          </View>
        </View>
        ...
        <View className="mb-6">
          ...
          <View className="space-y-2">
            <Pressable 
              onPress={testInvalidEmail}
              disabled={isLoading}
              className="bg-red-500 px-4 py-3 rounded-lg"
            >
              <Text className="text-white font-medium text-center">
                Test Invalid Email (36373@gmail.com)
              </Text>
            </Pressable>
        ...
        <View className="bg-yellow-500/20 border border-yellow-500/30 rounded-lg p-4 mt-4">
          ...
          <Text className="text-yellow-700 text-xs leading-5">
            Each test should show a specific error dialog. The old generic error banners should no longer appear. 
            Verify that each error message is user-friendly and specific to the error type.
          </Text>
        </View>
      </View>
    </SafeAreaView>
