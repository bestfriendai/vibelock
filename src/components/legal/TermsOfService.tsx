      ...
      <ScrollView className="flex-1 px-6 py-4">
        ...
        <View className="mb-6">
          ...
          <Text className="text-text-secondary text-sm leading-6 mb-3">
            Welcome to Locker Room Talk ("we," "our," "us," or "Company"). These Terms of Service ("Terms") govern your use of our mobile application and related services (collectively, the "Service").
          </Text>
        ...
        <View className="mb-6">
          ...
          <Text className="text-text-secondary text-sm leading-6 mb-3">
            Locker Room Talk is a platform that allows users to discover, review, and discuss various locations and experiences. The Service includes features such as:
          </Text>
        ...
        <View className="mb-6">
          ...
          <View className="ml-4 mb-3">
            <Text className="text-text-secondary text-sm leading-6">• Provide accurate, current, and complete information</Text>
            <Text className="text-text-secondary text-sm leading-6">• Maintain and update your account information</Text>
            <Text className="text-text-secondary text-sm leading-6">• Keep your login credentials secure and confidential</Text>
            <Text className="text-text-secondary text-sm leading-6">• Accept responsibility for all activities under your account</Text>
            <Text className="text-text-secondary text-sm leading-6">• Notify us immediately of any unauthorized use</Text>
          </View>
        </View>
        ...
        <View className="mb-6">
          ...
          <Text className="text-text-secondary text-sm leading-6 mb-3">
            <Text className="font-semibold">YOU ACKNOWLEDGE AND AGREE THAT THE COMPANY IS NOT RESPONSIBLE FOR ANY CONTENT POSTED BY USERS.</Text> All reviews, ratings, comments, messages, profiles, and other content ("User Content") are created and posted solely by users. The Company does not endorse, support, represent, or guarantee the completeness, truthfulness, accuracy, or reliability of any User Content.
          </Text>

          <Text className="text-text-primary text-base font-medium mb-2">
            4.2 No Editorial Control
          </Text>
          <Text className="text-text-secondary text-sm leading-6 mb-3">
            The Company acts as a passive conduit for User Content and does not exercise editorial control over such content. We do not pre-screen, monitor, or approve User Content before it is posted. Any opinions, advice, statements, or other information expressed in User Content are those of the respective users and not of the Company.
          </Text>
          ...
          <Text className="text-text-secondary text-sm leading-6 mb-3">
            <Text className="font-semibold">THE COMPANY EXPRESSLY DISCLAIMS ALL LIABILITY FOR USER CONTENT.</Text> You understand that by using the Service, you may be exposed to content that is offensive, indecent, inaccurate, misleading, or otherwise objectionable. You agree that the Company shall not be liable for any damages arising from such exposure.
          </Text>
        ...
        <View className="mb-6">
          ...
          <View className="ml-4 mb-3">
            <Text className="text-text-secondary text-sm leading-6">• Posting false, misleading, or defamatory content</Text>
            <Text className="text-text-secondary text-sm leading-6">• Harassing, threatening, or intimidating other users</Text>
            <Text className="text-text-secondary text-sm leading-6">• Posting content that violates intellectual property rights</Text>
            <Text className="text-text-secondary text-sm leading-6">• Sharing personal information of others without consent</Text>
            <Text className="text-text-secondary text-sm leading-6">• Attempting to gain unauthorized access to the Service</Text>
            <Text className="text-text-secondary text-sm leading-6">• Using automated systems to access or interact with the Service</Text>
            <Text className="text-text-secondary text-sm leading-6">• Posting spam, advertisements, or promotional content</Text>
            <Text className="text-text-secondary text-sm leading-6">• Engaging in illegal activities or encouraging others to do so</Text>
            <Text className="text-text-secondary text-sm leading-6">• Impersonating others or creating fake accounts</Text>
          </View>
        </View>
        ...
        <View className="mb-6">
          ...
          <Text className="text-text-secondary text-sm leading-6 mb-3">
            Users may report content that violates these Terms. We will investigate reports in good faith but make no guarantee regarding response time or action taken.
          </Text>
        ...
        <View className="mb-6">
          <Text className="text-text-primary text-lg font-semibold mb-3">
            8. Location-Based Services Disclaimer
          </Text>
          <Text className="text-text-secondary text-sm leading-6 mb-3">
            <Text className="font-semibold">LOCATION DATA ACCURACY DISCLAIMER:</Text> Location-based features rely on third-party data sources and GPS technology. We do not guarantee the accuracy, completeness, or reliability of location information. You acknowledge that:
          </Text>
          <View className="ml-4 mb-3">
            <Text className="text-text-secondary text-sm leading-6">• Location data may be inaccurate or outdated</Text>
            <Text className="text-text-secondary text-sm leading-6">• Business information may change without notice</Text>
            <Text className="text-text-secondary text-sm leading-6">• We are not responsible for navigation errors or misdirection</Text>
            <Text className="text-text-secondary text-sm leading-6">• You should verify location information independently</Text>
          </View>
        </View>
        ...
        <View className="mb-6">
          ...
          <Text className="text-text-secondary text-sm leading-6 mb-3">
            <Text className="font-semibold">WE ARE NOT RESPONSIBLE FOR ADVERTISING CONTENT.</Text> Advertisements displayed in the Service are provided by third parties. We do not endorse advertised products or services and are not liable for any damages arising from your interaction with advertisements.
          </Text>
        </View>
        ...
        <View className="mb-6">
          ...
          <Text className="text-text-secondary text-sm leading-6 mb-3">
            <Text className="font-semibold">THE SERVICE IS PROVIDED "AS IS" AND "AS AVAILABLE."</Text> We do not guarantee that the Service will be uninterrupted, secure, or error-free. We may modify, suspend, or discontinue the Service at any time without notice.
          </Text>
          ...
          <Text className="text-text-secondary text-sm leading-6 mb-3">
            <Text className="font-semibold">WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED,</Text> including but not limited to warranties of merchantability, fitness for a particular purpose, and non-infringement. We make no warranties about the accuracy, reliability, completeness, or timeliness of the Service or User Content.
          </Text>
          ...
          <Text className="text-text-secondary text-sm leading-6 mb-3">
            <Text className="font-semibold">TO THE MAXIMUM EXTENT PERMITTED BY LAW, THE COMPANY SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES,</Text> including but not limited to loss of profits, data, use, goodwill, or other intangible losses, resulting from your use of the Service.
          </Text>
        ...
        <View className="mb-6">
          ...
          <Text className="text-text-secondary text-sm leading-6 mb-3">
            <Text className="font-semibold">You agree to indemnify, defend, and hold harmless the Company</Text> and its officers, directors, employees, agents, and affiliates from and against any claims, liabilities, damages, losses, costs, expenses, or fees (including reasonable attorneys' fees) arising from:
          </Text>
          <View className="ml-4 mb-3">
            ...
            <Text className="text-text-secondary text-sm leading-6">• Your violation of any rights of another party</Text>
          </View>
        </View>
        ...
        <View className="mb-6">
          ...
          <Text className="text-text-secondary text-sm leading-6 mb-3">
            <Text className="font-semibold">YOU WAIVE ANY RIGHT TO PARTICIPATE IN A CLASS ACTION LAWSUIT</Text> or class-wide arbitration against the Company.
          </Text>
        </View>
