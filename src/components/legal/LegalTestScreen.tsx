  ...
  return (
    <SafeAreaView className="flex-1 bg-surface-900">
      <ScrollView className="flex-1 p-6">
        <Text className="text-text-primary text-2xl font-bold mb-6">Legal Documents Test</Text>
        ...
        <View className="bg-surface-800 rounded-lg mb-6">
          ...
          <Pressable onPress={() => setShowAcceptance(true)} className="p-4">
            <View className="flex-row items-center">
        ...
        <View className="bg-surface-800 rounded-lg mb-6">
          ...
          <View className="p-4">
            <Text className="text-text-secondary text-sm mb-3">Verify the following functionality:</Text>
      ...
      {showAcceptance && (
        <View className="absolute inset-0 bg-black/50 items-center justify-center p-6">
          <View className="bg-surface-900 rounded-lg w-full max-w-md">
            ...
            <View className="p-4">
              <LegalAcceptance onAccept={handleAcceptance} required={true} showTitle={false} />
            </View>

            <Pressable onPress={() => setShowAcceptance(false)} className="p-4 border-t border-surface-700">
